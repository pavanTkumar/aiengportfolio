...
const mockSearchResults: SearchResult[] = [
  ...
  },
  {
    ...
    description: 'Building scalable AI chatbots with React, FastAPI, and advanced NLP techniques',
    category: 'Full-Stack',
  ...
  },
  {
    ...
    description: 'End-to-end ML pipeline with MLOps, monitoring, and deployment strategies',
    category: 'AI/ML',
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <h4 className="text-neural-200 font-medium mb-1">
